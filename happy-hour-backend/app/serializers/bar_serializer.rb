class BarSerializer < ActiveModel::Serializer
    attributes :id, :name, :monday, :tuesday, :wednesday, :thursday, :friday, :saturday, :sunday, :military_start, :military_end, :date_array, :formatted_verified, :formatted_start, :formatted_end, :details, :phone, :address, :website, :image, :place_id, :lat, :lng, :favorites
